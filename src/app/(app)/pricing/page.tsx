            ...
            <div className="max-w-6xl mx-auto my-10">
                <div className="px-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div className="space-y-3 w-full  lg:w-[18rem] bg-textcolor text-[#d1cfcf] p-5 rounded-lg">
                            <h1 className="text-5xl font-bold ">Free Trial</h1>
                            <p className="text-[#d1cfcf]">Perfect for casual readers who want to get a taste of our content without any commitment. With the Free Plan, you'll get limited access to our most recent articles every month, along with exposure to ads.</p>
                            <div className="">
                        ...
                        <div className="space-y-3 w-full  lg:w-[22rem]  bg-primary border-textcolor border-2 p-5 rounded-lg group hover:bg-textcolor  transition-all cursor-pointer">
                            <h1 className="text-5xl font-bold text-textcolor group-hover:text-[#d1cfcf] ">Premium Plan</h1>
                            <p className="group-hover:text-[#d1cfcf]">
                            ...
                            <div className="">
                                ...
                                <ul className="space-y-2 group-hover:text-[#d1cfcf] list-disc px-5">
                        ...
                        <div className="space-y-3 w-full  lg:w-[22rem]  bg-primary border-textcolor border-2 p-5 rounded-lg group hover:bg-textcolor">
                            <h1 className="text-5xl font-bold text-textcolor group-hover:text-[#d1cfcf] ">Business/Pro Plan</h1>
                            <p className="group-hover:text-[#d1cfcf]">
